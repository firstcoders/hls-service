 ...
 */
import ddbPutRecord from '@firstcoders/service-libs/src/ddbPutRecord';
 ...
 * @returns void
 */
export default async (objectKey, contents, options) => {
  const { hostname, pathname } = new URL(options.sourceUrl);
